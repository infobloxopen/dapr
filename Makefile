...
COVERAGE_EXCLUDE_PATTERNS := \.pb\. zz_generated\. /testdata/ /cmd/ /tests/ /pkg/testing/ /pkg/channel/testing/ /pkg/client/ /monitoring/ /pkg/runtime/runtime\.go /pkg/runtime/cli\.go /pkg/operator/operator\.go /pkg/operator/client/ /pkg/sentry/sentry\.go /utils/utils\.go
